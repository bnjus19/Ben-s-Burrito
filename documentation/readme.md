...
- Create project - New Project in sidebar
    ...
    - names and descriptions should be relevant for you, e.g. bnjus-bootcamp
- Create -> Droplet
...
- the instructions for this depend on where you bought your domain. I recommend using Digital Ocean's documentation for configuring name servers
    - [documentation](# PWP Hosting Setup Codealong
...
- ssh into the server
    - For Mac and Linux: `ssh root@bensburrito.com`
    - For Windows: Set up a new PuTTY session
        ...
        - **Session**
            ...
            - Click Save
- create user
    - `useradd -m -s /bin/bash -g users -G sudo bnjus`
    - replace bnjus with your own
- create password
    - `passwd bnjus`
- Move .ssh key file
    - `cp -r .ssh /home/bnjus`
- change ownership of the .ssh directory
    - `cd /home/bnjus`
    - `chown -R bnjus:users .ssh/`


- Test Changes
    - `exit`
    - Mac/Linux: `ssh bnjus@bensburrito.com`
    - Windows:
        - **Session**
            - Click pwp
            - Click Load
...
- create a directory for your deployment
    - `sudo mkdir -p /var/www/bensburrito.com/html`
- fix permissions
    - `sudo chown -R $USER:users /var/www/bensburrito.com/html`
...
- `sudo vim /etc/nginx/sites-available/bensburrito.com`
...
server {
    ...
    root /var/www/bensburrito.com/html;
    index index.html index.htm index.nginx-debian.html;

    server_name bensburrito.com www.bensburrito.com;
...
- create a symlink to the sites-enabled directory
    - `sudo ln -s /etc/nginx/sites-available/bensburrito.com /etc/nginx/sites-enabled/`
...
- Create a new ssh key on your server in the .ssh directory
    - `ssh-keygen -t ed25519 -C  "github Deploy Key" -f /home/bnjus/.ssh/github_deploy_key`
    - Don't enter a passphrase
        - hit enter twice
- Copy the public key into your authorized keys file
    - `cat /home/bnjus/.ssh/github_deploy_key.pub >> /home/bnjus/.ssh/authorized_keys`
...
- Copy the private key to your clipboard **(this is a very dangerous operation do not share this key with anyone )**
    ...
    - `cat /home/bnjus/.ssh/github_deploy_key`
  ...
  deploy:
    ...
    steps:
      ...
      - name: Deploy to server
        run: |
         ssh-keyscan -H bensburrito.com >> ~/.ssh/known_hosts 
         scp -r ./dist/* bnjus@bensburrito.com:/var/www/bensburrito.com/html
```
